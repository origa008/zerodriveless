  ...
  return <div className="min-h-screen bg-white p-6 flex flex-col">
      ...
      <form onSubmit={handleSignup} className="flex-1 flex flex-col">
        ...
        <div className="mb-6">
          ...
          <Input type="text" value={referralCode} onChange={e => setReferralCode(e.target.value)} placeholder="Enter referral code" className="w-full p-4 text-lg rounded-xl py-[30px]" />
        </div>
