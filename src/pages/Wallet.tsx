      ...
      <div className="space-y-4">
        <div className="border-b border-gray-100 pb-4">
          <div className="flex justify-between">
            <div>
              <h3 className="font-medium">Ride to Angelina Paris Cafe</h3>
        ...
        <div className="border-b border-gray-100 pb-4">
          <div className="flex justify-between">
            <div>
              <h3 className="font-medium">Added to wallet</h3>
        ...
        <div className="border-b border-gray-100 pb-4">
          <div className="flex justify-between">
            <div>
              <h3 className="font-medium">Ride to Hotel Tiquetonne</h3>
